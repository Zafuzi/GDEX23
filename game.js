...
*/
System.register("squids", [], function (exports_1, context_1) {
    "use strict";
    var NOP, Squids;
    ...
    return {
        ...
        execute: function () {/*!
            ...
            */
            exports_1("NOP", NOP = function () {
            });
            (function (Squids) {
                var SquidEventTypes;
                (function (SquidEventTypes) {
                    SquidEventTypes["physics"] = "physics";
                    SquidEventTypes["tick"] = "tick";
                    SquidEventTypes["animate"] = "animate";
                    SquidEventTypes["draw"] = "draw";
                    SquidEventTypes["pointerdown"] = "pointerdown";
                })(SquidEventTypes = Squids.SquidEventTypes || (Squids.SquidEventTypes = {}));
                ...
                function sort_for_draw() {
                    ...
                    sorted_draw_listeners.sort(function (a, b) { return a.t.priority - b.t.priority; });
                }
                ...
                function emit() {
                    ...
                    for (var _a = 0, objs_1 = objs; _a < objs_1.length; _a++) { // walk through listeners ...
                        var o = objs_1[_a];
                ...
                var Squid = /** @class */ (function () {
                    function Squid(position, image, rotation, opacity, scale) {
                        this.default_tick = NOP;
                        this.id = seq();
                    ...
                    Squid.prototype.ignore = function (evt) {
                        if (Squids.listeners[evt] !== undefined) {
                            delete Squids.listeners[evt]["" + this.id];
                        }
                        return this;
                    };
                    Squid.prototype.ignore_all = function () {
                        var _this = this;
                    ...
                    Squid.prototype.draw_priority = function (n) {
                        if (n === undefined) {
                    ...
                    Squid.prototype.rotate_to = function (other) {
                        this.rotation = vector_to_rotation(this.position, other.position);
                        return this;
                    };
                    Squid.prototype.default_draw = function () {
                        var instance = this;
                        if (!instance.active) {
                            return;
                        }
                    ...
                    Squid.prototype.get_body = function () {
                        var _a, _b;
                        return this.body || {
                            x: this.position.x,
                            y: this.position.y,
                    ...
                    Squid.prototype.move_forward = function (amount) {
                    ...
                    Squid.prototype.default_physics = function () {
                        var instance = this;
                        if (!instance.active) {
                            return;
                        }
                    ...
                    Squid.prototype.default_animate = function () {
                        var instance = this;
                        if (!instance.active) {
                            return;
                        }
                    ...
                    Squid.prototype.destroy = function () {
                        this.ignore_all();
            ...
            })(Squids || (exports_1("Squids", Squids = {})));
        }
    };
});
System.register("game", ["squids"], function (exports_2, context_2) {
    "use strict";
    var squids_1;
    ...
    return {
        ...
        execute: function () {
            squids_1.Squids.load_assets("data", [
                "room1.png",
                "room2.png",
                "hallway.png",
                "person.png",
